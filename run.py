...
class Run:
    ...
    def do(self):
        ...
        self.frame += FPS_RUN * game_framework.frame_time
    ...
    def draw(self):
        ...
        if self.player.dir == 1:
            ...
            self.image.clip_composite_draw(frame * self.player.w, 0, self.player.w, self.player.h,0, 'h',self.player.x, self.player.y, self.player.w * 3, self.player.h * 3)